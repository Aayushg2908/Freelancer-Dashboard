...
export default function ProjectTypesBarChart({ chartData }: propsTypes) {
  return (
    <Card className=" dark:bg-[#09090B] !dark:border-neutral-900 flex flex-col">
      <Title className="uppercase font-semibold text-textColor">
        Project Types distribution{" "}
      </Title>
      <Subtitle className="dark:text-neutral-400 text-neutral-500/80 text-[15px] mt-1">
        Explore a detailed breakdown of how many projects you have for each
